...
const STRINGS: Record<Lang, Dict> = {
  ...
  "zh-Hant": {
    ...
    danger_low: "低",
    threat_malware: "惡意軟體",
    threat_social_engineering: "釣魚／社交工程詐騙",
    threat_unwanted_software: "不良軟體",
    threat_potentially_harmful_application: "可能有害的應用程式",
    threat_phishing: "釣魚網站",
    what_to_do: "現在該怎麼做",
    ...
    limit_body: "每天可免費檢查 3 次。請明天再來 — 次數會在午夜重新開始。",
